...
def addStudent(prenom, nom, id_film, id_genre):
    ...
    if result["nb"] > 0:
        ...
        return jsonify({"success": False, "message": "Étudiant déjà existant"}), 400
    ...
    return jsonify({"success": True, "message": "Étudiant ajouté"}), 201
...
def editStudent(id, prenom, nom, id_film, id_genre):
    ...
    return jsonify({"success": True, "message": "Étudiant modifié"}), 200
...
def deleteStudent(id):
    ...
    return jsonify({"success": True, "message": "Étudiant supprimé"}), 200
...
def addFilm(nom, annee):
    ...
    if result["nb"] > 0:
        ...
        return jsonify({"success": False, "message": "Film déjà existant"}), 400
    ...
    mydb.commit()
    flash("Film ajouté !")
    return jsonify({"success": True, "message": "Film ajouté"}), 201
...
def editFilm(id, nom, annee, genres_ids, directors_ids):
    ...
    mydb.commit()
    flash("Film modifié !")
    return jsonify({"success": True, "message": "Film modifié"}), 200
...
def deleteFilm(id):
    ...
    if used_by_student > 0:
        ...
        return jsonify({"success": False, "message": "Film utilisé par un étudiant"}), 400
    ...
    mydb.commit()
    flash("Film supprimé !")
    return jsonify({"success": True, "message": "Film supprimé"}), 200
...
def addGenre(nom):
    ...
    if result["nb"] > 0:
        ...
        return jsonify({"success": False, "message": "Genre déjà existant"}), 400

    mycursor.execute("INSERT INTO GENRE (nom) VALUES (%s)", (nom,))
    mydb.commit()
    flash("Genre ajouté !")
    return jsonify({"success": True, "message": "Genre ajouté"}), 201
...
def editGenre(id, nom):
    ...
    mydb.commit()
    flash("Genre modifié !")
    return jsonify({"success": True, "message": "Genre modifié"}), 200
...
def deleteGenre(id):
    ...
    if used_by_film > 0 or used_by_student > 0:
        ...
        return jsonify({"success": False, "message": "Genre utilisé par un film ou un étudiant"}), 400
    mycursor.execute("DELETE FROM GENRE WHERE id=%s", (id,))
    mydb.commit()
    flash("Genre supprimé !")
    return jsonify({"success": True, "message": "Genre supprimé"}), 200
...
def addDirector(nom):
    ...
    if result["nb"] > 0:
        ...
        return jsonify({"success": False, "message": "Réalisateur déjà existant"}), 400

    mycursor.execute("INSERT INTO REALISATEUR (nom) VALUES (%s)", (nom,))
    mydb.commit()
    flash("Réalisateur ajouté !")
    return jsonify({"success": True, "message": "Réalisateur ajouté"}), 201
...
def editDirector(id, nom):
    ...
    return jsonify({"success": True, "message": "Réalisateur modifié"}), 200
...
def deleteDirector(id):
    ...
    if used_by_film > 0:
        ...
        return jsonify({"success": False, "message": "Réalisateur utilisé par un film"}), 400
    mycursor.execute("DELETE FROM REALISATEUR WHERE id=%s", (id,))
    mydb.commit()
    flash("Réalisateur supprimé !")
    return jsonify({"success": True, "message": "Réalisateur supprimé"}), 200
